...
///          Watershed() and WatershedDirectional() functions.  These functions
///          divide an image into multiple regions.  Each region is associated
...
/// @brief  This is a version of the Watershed algorithm which is sensitive
///         to directional features in the image.  Like the Watershed algorithm,
...
///         in the source image.  However this function has an optional feature:
...
size_t
WatershedDirectional(const int image_size[3],                   //!< #voxels in xyz
