...
# COMMENTING OUT:
# setenv MY_FLAGS "-std=c++17 -O3 -DNDEBUG -DCXX17_UNSUPPORTED -ffast-math -DDISABLE_OPENMP"
# INSTEAD USE:
setenv MY_FLAGS "-std=c++17 -DNDEBUG -DCXX17_UNSUPPORTED -ffast-math -DDISABLE_OPENMP"
